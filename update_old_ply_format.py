...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", "-p", help="Path of the ply file to convert", type=str, default='/data/liufengyi/res_gs/AtomGS_all_sky/garden_nosky_depth_dis/point_cloud/iteration_30000/point_cloud.ply')
    parser.add_argument("--name", "-n", help="Name of the newly created point cloud", type=str, default='/data/liufengyi/res_gs/AtomGS_all_sky/garden_nosky_depth_dis/point_cloud/iteration_30000/reduce.ply')
