...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_dir', default="/data/liufengyi/data_gs/360_v2/garden")
    parser.add_argument('--depths_dir', default="/data/liufengyi/data_gs/360_v2/garden/depth")
