...
def train_scene(gpu, scene, factor, weight):
    cmds = [
            ...
            f"CUDA_VISIBLE_DEVICES={gpu} python train.py -s {data_dir}/{scene}/ -m {output_dir}/{scene}_nosky  --port 8000",
            f"CUDA_VISIBLE_DEVICES={gpu} python render.py -s {data_dir}/{scene}/ -m {output_dir}/{scene}_nosky --skip_test",
